...
* Led by: Nadav Avital
* Present: Anderson Lee, Danny Rose, Michael Hu, Audrey Zhou, Josh Sun, Nadav Avital, Eric Marzouk (online)
* Absent: 
...
- We used the start, stop, continue method. We took 10 minutes to each write down our own points, and then went around 3 times sharing our starts, stops, and continues. Then we consolidated those into 3 bullet points for each category. We also had Eric participate online via text.
...
- Change: We think we'll continue but with the addendum: when checking out to a new branch, pull from main if you don't checkout from main so your branches don't become to behind. But branching really helps. 
